  ...
  return (
    <div className='main'>
      <div className="main__noteEdit">
        ...
        <textarea id="content" placeholder="Write contents here!" value={activeNote.content} onChange={(e) => onEditNote("content", e.target.value)}></textarea>
      </div>

      <div className="main__notePreview">
        <h1 className='main__previewTitle'>{activeNote.title}</h1>
        <div className='main__markdownPreciew'>{activeNote.content}</div>
      </div>
